    ...
    <div className='min-h-screen bg-[linear-gradient(-40deg,#090D1A,#1E293B)] w-full flex flex-col justify-center items-center font-sans'>
        <div className='w-[440px] h-[592px] rounded-[24px] bg-white p-[40px] ' >
            ...
            <form action="" className='mt-[24px] flex flex-col gap-[20px]'>
                <div className='flex flex-col gap-[6px]'>
                    ...
                    <div className='relative' >
                        ...
                        <input type="email" onFocus={() => setEmailFocused(true)} onBlur={() => setEmailFocused(false)} placeholder='name@yourgroup.com' className={`w-full p-[16px] h-[48px] transition-[padding] font-inter text-[14px] text-[#94A3B8] duration-200 ease-in-out rounded-[12px] border-1 border-[#E2E8F0] ${emailFocused ? 'pl-[16px]' : 'pl-[48px]'} focus:border-[#FF6B57] outline-none font-light`} />
                    </div>
                </div>
                <div className='flex flex-col gap-[6px]'>
            ...
            <div className='flex justify-between items-center mt-[14px]'>
                ...
                <span className='font-inter text-[12px] text-[rgb(148,163,184)] '>or</span>
                <hr className='w-[45%] border-[#E2E8F0]' />
            </div>
